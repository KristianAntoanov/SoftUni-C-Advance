...
namespace MilitaryElite
{
    public class Engine : IEngine
    {
        ...
        private string ProcessInput(string[] tokens)
        {
            ...
            switch (soldierType)
            {
                ...
                case "LieutenantGeneral":
                    soldier = GetLeutenantGeneral(id, firstName, lastName, tokens);
                    break;
                case "Engineer":
        ...
        private ISoldier GetLeutenantGeneral(int id, string firstName, string lastName, string[] tokens)
        {
            ...
            for (int i = 5; i < tokens.Length; i++)
            {
                ...
                IPrivate currSoldier = (IPrivate)soldiers[soldierId];
                privates.Add(currSoldier);
            }
